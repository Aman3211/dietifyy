...
public class lunchdetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button nutrientsButton = findViewById(R.id.nutrients);
        ScrollView nutrientsScrollView = findViewById(R.id.nutrientsscrollv);
        TextView nutrientsInfoTextView = findViewById(R.id.nutrients_info);
        Button itemInfoButton = findViewById(R.id.iteminfo);
        ScrollView itemInfoScrollView = findViewById(R.id.iteminfoscrollv);
        TextView itemInfoTextView = findViewById(R.id.item_info);
        upwardImageView = findViewById(R.id.upward);
        downwardImageView = findViewById(R.id.downward);
