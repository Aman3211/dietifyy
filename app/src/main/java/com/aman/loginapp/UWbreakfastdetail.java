...
public class UWbreakfastdetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uwbreakfastdetail);
        ...
        itemImageView = findViewById(R.id.UWbreakfastitem_img);
        TextView breakfastTitleTextView = findViewById(R.id.UWbreakfast_title);
        Button nutrientsButton = findViewById(R.id.UWbreakfastnutrients);
        ScrollView nutrientsScrollView = findViewById(R.id.UWbreakfastnutrientsscrollv);
        TextView nutrientsInfoTextView = findViewById(R.id.UWbreakfastnutrients_info);
        Button itemInfoButton = findViewById(R.id.UWbreakfastiteminfo);
        ScrollView itemInfoScrollView = findViewById(R.id.UWbreakfastiteminfoscrollv);
        TextView itemInfoTextView = findViewById(R.id.UWbreakfastitem_info);
        upwardImageView = findViewById(R.id.UWbreakfastupward);
        downwardImageView = findViewById(R.id.UWbreakfastdownward);
        relativeLayout = findViewById(R.id.UWbreakfastrelativeLayout);
        ...
        ImageView backBtn = findViewById(R.id.UWbreakfastback_btn);
