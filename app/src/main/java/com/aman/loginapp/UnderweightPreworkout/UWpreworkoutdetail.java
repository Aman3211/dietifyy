...
public class UWpreworkoutdetail extends AppCompatActivity {
        ...
        setContentView(R.layout.activity_uwpreworkoutdetail);
        ...
        itemImageView = findViewById(R.id.UWpreworkoutitem_img);
        TextView preworkoutTitleTextView = findViewById(R.id.UWpreworkout_title);
        Button nutrientsButton = findViewById(R.id.UWpreworkoutnutrients);
        ScrollView nutrientsScrollView = findViewById(R.id.UWpreworkoutnutrientsscrollv);
        TextView nutrientsInfoTextView = findViewById(R.id.UWpreworkoutnutrients_info);
        Button itemInfoButton = findViewById(R.id.UWpreworkoutiteminfo);
        ScrollView itemInfoScrollView = findViewById(R.id.UWpreworkoutiteminfoscrollv);
        TextView itemInfoTextView = findViewById(R.id.UWpreworkoutitem_info);
        upwardImageView = findViewById(R.id.UWpreworkoutupward);
        downwardImageView = findViewById(R.id.UWpreworkoutdownward);
        relativeLayout = findViewById(R.id.UWpreworkoutrelativeLayout);
        ...
        ImageView backBtn = findViewById(R.id.UWpreworkoutback_btn);
